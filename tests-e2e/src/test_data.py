...
METRICS_WITH_INITIAL_VALUE_ZERO = [
    ...
    "logos_delivery_rln_messages_total_total",
    "logos_delivery_rln_spam_messages_total_total",
    "logos_delivery_rln_proof_verification_total_total",
    "logos_delivery_rln_number_registered_memberships",
    "logos_delivery_rln_proof_verification_duration_seconds",
    "logos_delivery_rln_proof_generation_duration_seconds",
    ...
    "logos_delivery_peer_store_size",
    "logos_delivery_total_unique_peers",
    "presto_server_missing_requests_count",
    "presto_server_invalid_requests_count",
    'logos_delivery_archive_messages{type="stored"}',
    "logos_delivery_archive_insert_duration_seconds_sum",
    "logos_delivery_archive_insert_duration_seconds_count",
    'logos_delivery_archive_insert_duration_seconds_bucket{le="0.005"}',
    'logos_delivery_archive_insert_duration_seconds_bucket{le="0.01"}',
    'logos_delivery_archive_insert_duration_seconds_bucket{le="0.025"}',
    'logos_delivery_archive_insert_duration_seconds_bucket{le="0.05"}',
    'logos_delivery_archive_insert_duration_seconds_bucket{le="0.075"}',
    'logos_delivery_archive_insert_duration_seconds_bucket{le="0.1"}',
    'logos_delivery_archive_insert_duration_seconds_bucket{le="0.25"}',
    'logos_delivery_archive_insert_duration_seconds_bucket{le="0.5"}',
    'logos_delivery_archive_insert_duration_seconds_bucket{le="0.75"}',
    'logos_delivery_archive_insert_duration_seconds_bucket{le="1.0"}',
    'logos_delivery_archive_insert_duration_seconds_bucket{le="2.5"}',
    'logos_delivery_archive_insert_duration_seconds_bucket{le="5.0"}',
    'logos_delivery_archive_insert_duration_seconds_bucket{le="7.5"}',
    'logos_delivery_archive_insert_duration_seconds_bucket{le="10.0"}',
    'logos_delivery_archive_insert_duration_seconds_bucket{le="+Inf"}',
    "logos_delivery_archive_query_duration_seconds_sum",
    "logos_delivery_archive_query_duration_seconds_count",
    'logos_delivery_archive_query_duration_seconds_bucket{le="0.005"}',
    'logos_delivery_archive_query_duration_seconds_bucket{le="0.01"}',
    'logos_delivery_archive_query_duration_seconds_bucket{le="0.025"}',
    'logos_delivery_archive_query_duration_seconds_bucket{le="0.05"}',
    'logos_delivery_archive_query_duration_seconds_bucket{le="0.075"}',
    'logos_delivery_archive_query_duration_seconds_bucket{le="0.1"}',
    'logos_delivery_archive_query_duration_seconds_bucket{le="0.25"}',
    'logos_delivery_archive_query_duration_seconds_bucket{le="0.5"}',
    'logos_delivery_archive_query_duration_seconds_bucket{le="0.75"}',
    'logos_delivery_archive_query_duration_seconds_bucket{le="1.0"}',
    'logos_delivery_archive_query_duration_seconds_bucket{le="2.5"}',
    'logos_delivery_archive_query_duration_seconds_bucket{le="5.0"}',
    'logos_delivery_archive_query_duration_seconds_bucket{le="7.5"}',
    'logos_delivery_archive_query_duration_seconds_bucket{le="10.0"}',
    'logos_delivery_archive_query_duration_seconds_bucket{le="+Inf"}',
    "logos_delivery_filter_subscriptions",
    "logos_delivery_filter_handle_message_duration_seconds_sum",
    "logos_delivery_filter_handle_message_duration_seconds_count",
    'logos_delivery_filter_handle_message_duration_seconds_bucket{le="0.005"}',
    'logos_delivery_filter_handle_message_duration_seconds_bucket{le="0.01"}',
    'logos_delivery_filter_handle_message_duration_seconds_bucket{le="0.025"}',
    'logos_delivery_filter_handle_message_duration_seconds_bucket{le="0.05"}',
    'logos_delivery_filter_handle_message_duration_seconds_bucket{le="0.075"}',
    'logos_delivery_filter_handle_message_duration_seconds_bucket{le="0.1"}',
    'logos_delivery_filter_handle_message_duration_seconds_bucket{le="0.25"}',
    'logos_delivery_filter_handle_message_duration_seconds_bucket{le="0.5"}',
    'logos_delivery_filter_handle_message_duration_seconds_bucket{le="0.75"}',
    'logos_delivery_filter_handle_message_duration_seconds_bucket{le="1.0"}',
    'logos_delivery_filter_handle_message_duration_seconds_bucket{le="2.5"}',
    'logos_delivery_filter_handle_message_duration_seconds_bucket{le="5.0"}',
    'logos_delivery_filter_handle_message_duration_seconds_bucket{le="7.5"}',
    'logos_delivery_filter_handle_message_duration_seconds_bucket{le="10.0"}',
    'logos_delivery_filter_handle_message_duration_seconds_bucket{le="+Inf"}',
    ...
    "logos_delivery_px_peers_received_total",
    "logos_delivery_px_peers_received_unknown",
    "logos_delivery_px_peers_sent_total",
    "logos_delivery_px_peers",
    "logos_delivery_histogram_message_size_sum",
    "logos_delivery_histogram_message_size_count",
    'logos_delivery_histogram_message_size_bucket{le="0.0"}',
    'logos_delivery_histogram_message_size_bucket{le="1.0"}',
    'logos_delivery_histogram_message_size_bucket{le="3.0"}',
    'logos_delivery_histogram_message_size_bucket{le="5.0"}',
    'logos_delivery_histogram_message_size_bucket{le="15.0"}',
    'logos_delivery_histogram_message_size_bucket{le="50.0"}',
    'logos_delivery_histogram_message_size_bucket{le="75.0"}',
    'logos_delivery_histogram_message_size_bucket{le="100.0"}',
    'logos_delivery_histogram_message_size_bucket{le="125.0"}',
    'logos_delivery_histogram_message_size_bucket{le="150.0"}',
    'logos_delivery_histogram_message_size_bucket{le="500.0"}',
    'logos_delivery_histogram_message_size_bucket{le="700.0"}',
    'logos_delivery_histogram_message_size_bucket{le="1000.0"}',
    'logos_delivery_histogram_message_size_bucket{le="+Inf"}',
    "logos_delivery_lightpush_peers",
    "logos_delivery_filter_peers",
    "logos_delivery_store_peers",
    "logos_delivery_px_peers",
    "logos_delivery_dnsdisc_discovered",
    "logos_delivery_rendezvous_peer_found_total",
    "logos_delivery_reconciliation_roundtrips_sum",
    "logos_delivery_reconciliation_roundtrips_count",
    "logos_delivery_reconciliation_differences_sum",
    "logos_delivery_reconciliation_differences_count",
    'logos_delivery_reconciliation_roundtrips_bucket{le="1.0"}',
    'logos_delivery_reconciliation_roundtrips_bucket{le="2.0"}',
    'logos_delivery_reconciliation_roundtrips_bucket{le="3.0"}',
    'logos_delivery_reconciliation_roundtrips_bucket{le="5.0"}',
    'logos_delivery_reconciliation_roundtrips_bucket{le="8.0"}',
    'logos_delivery_reconciliation_roundtrips_bucket{le="13.0"}',
    'logos_delivery_reconciliation_roundtrips_bucket{le="+Inf"}',
    'logos_delivery_reconciliation_differences_bucket{le="0.0"}',
    'logos_delivery_reconciliation_differences_bucket{le="10.0"}',
    'logos_delivery_reconciliation_differences_bucket{le="50.0"}',
    'logos_delivery_reconciliation_differences_bucket{le="100.0"}',
    'logos_delivery_reconciliation_differences_bucket{le="500.0"}',
    'logos_delivery_reconciliation_differences_bucket{le="1000.0"}',
    'logos_delivery_reconciliation_differences_bucket{le="5000.0"}',
    'logos_delivery_reconciliation_differences_bucket{le="+Inf"}',
    'logos_delivery_filter_handle_message_duration_seconds_bucket{le="15.0"}',
    'logos_delivery_filter_handle_message_duration_seconds_bucket{le="20.0"}',
    'logos_delivery_filter_handle_message_duration_seconds_bucket{le="30.0"}',
    "logos_delivery_total_messages_cached",
    "logos_delivery_store_queries_total",
    "mix_pool_size",
    "libp2p_gossipsub_imreceiving_saved_messages_total",
    "logos_delivery_postgres_payload_size_bytes",
]

...
declarePublicCounter logos_delivery_store_errors,
  "number of store protocol errors", ["type"]
declarePublicCounter logos_delivery_store_queries, "number of store queries received"
...
declarePublicGauge logos_delivery_store_time_seconds,
